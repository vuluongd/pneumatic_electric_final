...
void calibrateCylinders() {
  ...
  if (elapsedTime <= 4000) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      if (elapsedTime >= 3500) {
        ...
        if (millis() - cylinders[i].lastAnalogRead >= 20) {
          ...
          // Sau khi đọc đủ 10 lần, tính trung bình cho analogMax
    ...
    for (int i = 0; i < 3; i++) {
      ...
      if (elapsedTime >= 7500) {
        ...
        if (millis() - cylinders[i].lastAnalogRead >= 20) {
          ...
          // Sau khi đọc đủ 10 lần, tính trung bình cho analogMin
          if (cylinders[i].analogReadCount >= 10) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      // Đọc vị trí hiện tại và lưu làm vị trí khởi đầu
